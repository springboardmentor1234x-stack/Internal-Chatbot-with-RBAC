...
class QueryNormalizer:
    ...
    def generate_variants(self, query: str) -> List[str]:
        ...
        # Variant 1: Remove common stop words for more focused search
        ...
        # Variant 2: Extract key terms (nouns and important keywords)
        key_terms = self._extract_key_terms(query)
        if key_terms and key_terms != query:
            variants.append(key_terms)
        
        # Variant 3: Expand with synonyms for financial/business terms
    ...
    def _extract_key_terms(self, query: str) -> str:
        # Important keywords in our domain
        important_terms = {
